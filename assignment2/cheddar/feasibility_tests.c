...
//
U32_T ex0_period[] = {2, 5, 7, 14};
U32_T ex0_wcet[] = {1, 1, 1, 2};

// U=
U32_T ex1_period[] = {2, 4, 8};
...
U32_T ex3_wcet[] = {1, 2, 4};

// U=1.0
U32_T ex4_period[] = {2, 5, 7, 13};
U32_T ex4_wcet[] = {1, 1, 1, 2};
...
{ 
    ...
    printf("sched-example-10-above-LUB-disharmonic U=%4.2f (C1=1, C2=1, C3=2; T1=2, T2=10, T3=15; T=D): ",
    ...
    printf("sched-example-12-above-LUB-harmonic U=%4.2f (C1=1, C2=1, C3=2; T1=2, T2=5, T3=7; T=D): ", 
    ...
    printf("sched-example-4-above-LUB-harmonic U=%4.2f (C1=1, C2=1, C3=1, C4=2; T1=2, T2=5, T3=7, T4=13; T=D): ",
    ...
    printf("sched-example-7-above-LUB-harmonic-EDF-and-LLF-difference U=%4.2f (C1=1, C2=2, C3=3; T1=3, T2=5, T3=15; T=D): ",
    ...
    printf("sched-example-8-above-LUB-failure-disharmonic U=%4.2f (C1=1, C2=1, C3=4; T1=2, T2=4, T3=16; T=D): ",
